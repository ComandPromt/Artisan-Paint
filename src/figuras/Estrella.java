...
public class Estrella extends Figura {
 Graphics2D g2;
    ...
    public void dibujar(Graphics g) {
        ...
        Point punto6 = new Point(x + (int) (anchura / 2), y + (int) (altura / 1.285714285));
        ...
        int[] puntosX = {punto1.x, punto2.x, punto3.x, punto4.x, punto5.x, punto6.x, punto7.x, punto8.x, punto9.x, punto10.x};
        int[] puntosY = {punto1.y, punto2.y, punto3.y, punto4.y, punto5.y, punto6.y, punto7.y, punto8.y, punto9.y, punto10.y};
