...
public class MarcoDeFigura {
    ...
    public MarcoDeFigura(Point ubicacion, int anchura, int altura) {
        this.ubicacion = ubicacion;
        this.altura = altura;
        this.anchura = anchura;
        posicionCursor = "FUERA_DEL_AREA";//Quizas pude usar otro metodo, pero esto fue efectivo.
        area = 5;
    }
    ...
    public void desplazarFigura(Point puntoActual) {
        ...
        System.out.println(posicionCursor);
	...
	// Lados - En Base a los 4 metodos de lados, se hacen todos los desplasamientos.
