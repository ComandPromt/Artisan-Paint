...
/**
 * <p>
 * <b>Overview.</b> The {@code StdDraw} class provides a basic capability for
 * creating drawings with your programs. It uses a simple graphics model that
 * allows you to create drawings consisting of points, lines, squares, circles,
 * and other geometric shapes in a window on your computer and to save the
 * drawings to a file. Standard drawing also includes facilities for text,
 * color, pictures, and animation, along with user interaction via the keyboard
 * and mouse.
 * <p>
 ...
 * to magenta.
 * <p>
 * <b>Window title.</b> By default, the stanard drawing window title is
 * "Standard Draw". You can change the title with the following method:
 * <ul>
 ...
 * and BMP). The image will display at its native size, independent of the
 * coordinate system. Optionally, you can rotate the image a specified number of
 * degrees counterclockwise or rescale it to fit snugly inside a width-by-height
 * bounding box.
 * <p>
 * <b>Saving to a file.</b> You can save your image to a file using the <em>File
 ...
 * </ul>
 * <p>
 * You can save the drawing to a file in a supported file format (typically
 * JPEG, PNG, GIF TIFF, and BMP). We recommend using PNG for drawing that
 * consist solely of geometric shapes and JPEG for drawings that contains
 * pictures.
 * <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	 ...
	 * image formats are typically JPEG, PNG, GIF TIFF, and BMP. As an optimization,
	 * the picture is cached, so there is no performance penalty for redrawing the
	 * same image multiple times (e.g., in an animation). However, if you change the
	 * picture file after drawing it, subsequent calls will draw the original
	 * picture.
	 *
	 ...
	 * number of degrees. The supported image formats are typically JPEG, PNG, GIF
	 * TIFF, and BMP.
	 *
	 * @param x        the center <em>x</em>-coordinate of the image
	 * @param y        the center <em>y</em>-coordinate of the image
	 ...
	 * the specified bounding box. The supported image formats are typically JPEG,
	 ...
	 * image formats are typically JPEG, PNG, GIF TIFF, and BMP.
	 *
	 * @param x            the center <em>x</em>-coordinate of the image
	 * @param y            the center <em>y</em>-coordinate of the image
	 * @param filename     the name of the image/picture, e.g., "ball.gif"
	 ...
	 * formats are typically JPEG, PNG, GIF TIFF, and BMP.
	 *
